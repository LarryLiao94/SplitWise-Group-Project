...
function AddExpenseForm() {
  ...
  const handleSubmit = (e) => {
    ...
    return dispatch(sessionActions.login({ credential, description, amount, image,group })).catch(
      async (res) => {
  ...
  return (
    <form className='add-expense-form' onSubmit={handleSubmit}>
      ...
      <input className='add-expense-credential-input'
              type="text"
              value={credential}
      ...
      <div className='add-expense-main'>
        <div className='add-expense-details-div'>
          ...
          <a className='default-image-link'>
            <img className='default-image' src='https://s3.amazonaws.com/splitwise/uploads/category/icon/square_v2/uncategorized/general@2x.png' height='75' width='75'/>
          </a>

          <div className='add-expense-input-div'>
              <input className='add-expense-description' placeholder='Enter a description'/>
              <div className='add-expense-amount-div'>
                <p className='add-expense-dollar'>
                  $
                </p>
          ...
          <div className='add-expense-split-div'>
            ...
            <div className='add-expense-owner'>
              you
            </div>
            <div className='and-split-text'> and split </div>
            <div className='add-expense-distribution-text'>
              equally
            </div>
            {/* <div className>.</div> */}
            </div>
      ...
      <div className='add-expense-footer'>
          <button className='add-expense-cancel'>
            Cancel
          </button>
